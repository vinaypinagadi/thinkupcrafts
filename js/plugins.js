    ...
    h.prototype = {
        ...
        open: function(n) {
            ...
            if (!t.isOpen) {
                ...
                b("BeforeOpen"), t.st.showCloseBtn && (t.st.closeBtnInside ? (C(c, (function(e, t, n, i) {
                    n.close_replaceWith = I(i.type)
                })), a += " mfp-close-btn-in") : t.wrap.append(I())), t.st.alignTop && (a += " mfp-align-top"), t.wrap.css(t.fixedContentPos ? {
                ...
                }), 16), t.isOpen = !0, t.updateSize(m), b(d), n
            }
            t.updateItemHTML()
        },
        close: function() {
        ...
        appendContent: function(e, n) {
            t.content = e, e ? t.st.showCloseBtn && t.st.closeBtnInside && !0 === t.currTemplate[n] ? t.content.find(".mfp-close").length || t.content.append(I()) : t.content = e : t.content = "", b("BeforeAppend"), t.container.addClass("mfp-" + n + "-holder"), t.contentContainer.append(t.content)
        },
        parseEl: function(n) {
            var i, o = t.items[n];
            if (o.tagName ? o = {
        ...
        _parseMarkup: function(t, n, i) {
            var o;
            i.data && (n = e.extend(i.data, n)), b(c, [t, n, i]), e.each(n, (function(e, n) {
        ...
        if ("string" == typeof n)
            if ("open" === n) {
                var o, a = v ? i.data("magnificPopup") : i[0].magnificPopup,
            ...
            getAjax: function(n) {
                ...
                var i = e.extend({
                    ...
                    success: function(i, o, a) {
                        ...
                        b("ParseAjax", r), t.appendContent(e(r.data), O), n.finished = !0, z(), t._setFocus(), setTimeout((function() {
                            t.wrap.addClass(f)
    ...
    e.magnificPopup.registerModule("image", {
        ...
        proto: {
            initImage: function() {
                var n = t.st.image,
                    i = ".image";
                t.types.push("image"), C(d + i, (function() {
            ...
            getImage: function(n, i) {
                var o = 0,
                    a = function() {
                        n && (n.img[0].complete ? (n.img.off(".mfploader"), n === t.currItem && (t._onImageHasSize(n), t.updateStatus("ready")), n.hasSize = !0, n.loaded = !0, b("ImageLoadComplete")) : 200 > ++o ? setTimeout(a, 100) : r())
                    },
                    r = function() {
    ...
    e.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                ...
                return t.direction = !0, !!n && !!n.enabled && (a += " mfp-gallery", C(d + o, (function() {
                    ...
                    if (t.items.length > 1 && n.arrows && !t.arrowLeft) {
                        ...
                        o[s]((function() {
                            ...
                            t.next()
                        })), t.isIE7 && (w("b", o[0], !1, !0), w("a", o[0], !1, !0), w("b", a[0], !1, !0), w("a", a[0], !1, !0)), t.container.append(o.add(a))
                    }
                })), C(u + o, (function() {
    ...
    e.magnificPopup.registerModule(q, {
        ...
        return e(this).each((function() {
            ...
            W && c.on("touchstart" + Z, (function(e) {
                a = !1, s = 1, i = (r = e.originalEvent ? e.originalEvent.touches[0] : e.touches[0]).clientX, o = r.clientY, y.on("touchmove" + Z, (function(e) {
                    ...
                    R(), a || s > 1 || (l = !0, e.preventDefault(), clearTimeout(n), n = setTimeout((function() {
                        l = !1
                    }), 1e3), t())
                }))
...
! function(t, e) {
    ...
    var a, r, l = function() {
        ...
        c = window.getComputedStyle || function(t) {
            var e = /(\-([a-z]){1})/g;
            return {
        ...
        f = function() {
            function t() {
                ...
                n(this, t), this.defaults = {
                    ...
                    return t()
                }, this.vendors = ["moz", "webkit"], this.start = this.start.bind(this), this.resetAnimation = this.resetAnimation.bind(this), this.scrollHandler = this.scrollHandler.bind(this), this.scrollCallback = this.scrollCallback.bind(this), this.scrolled = !0, this.config = function t(e, n) {
                    for (var i in n)
                        if (null == e[i]) {
                            var s = n[i];
                            e[i] = s
                    ...
                    return e
                }(e, this.defaults), null != e.scrollContainer && (this.config.scrollContainer = document.querySelector(e.scrollContainer)), this.animationNameCache = new u, this.wowEvent = function t(e) {
                    var n = !(arguments.length <= 1) && void 0 !== arguments[1] && arguments[1],
                        i = !(arguments.length <= 2) && void 0 !== arguments[2] && arguments[2],
                        s = arguments.length <= 3 || void 0 === arguments[3] ? null : arguments[3],
                        o = void 0;
                    return null != document.createEvent ? (o = document.createEvent("CustomEvent")).initCustomEvent(e, n, i, s) : null != document.createEventObject ? (o = document.createEventObject()).eventType = e : o.eventName = e, o
            ...
            return l(t, [{
                ...
                value: function() {
                    ...
                    this.disabled() || (s(this.config.scrollContainer || window, "scroll", this.scrollHandler), s(window, "resize", this.scrollHandler), this.interval = setInterval(this.scrollCallback, 50)), this.config.live && new h(function(e) {
                        for (var n = 0; n < e.length; n++)
                ...
                value: function(t) {
                    if (null != t || (t = this.element), 1 === t.nodeType) {
                        ...
                        for (var e = t.querySelectorAll("." + this.config.boxClass), n = 0; n < e.length; n++) {
                            var s = e[n];
                            i(s, this.all) || (this.boxes.push(s), this.all.push(s), this.stopped || this.disabled() ? this.resetStyle() : this.applyStyle(s, !0), this.scrolled = !0)
                        }
                    }
                }
            }, {
                ...
                value: function(t, e, n, i, s) {
                    return e && this.cacheAnimationName(t), t.style.visibility = "visible", n && this.vendorSet(t.style, {
                        animationDuration: n
                ...
                value: function(t, e) {
                    for (var n in e)
                        if (e.hasOwnProperty(n)) {
                            var i = e[n];
                            t["" + n] = i;
                            for (var s = 0; s < this.vendors.length; s++) t["" + this.vendors[s] + n.charAt(0).toUpperCase() + n.substr(1)] = i
                        }
                }
            }, {
                key: "vendorCSS",
...
TxtType.prototype.tick = function() {
    ...
    this.isDeleting && (s /= 5), this.isDeleting || this.txt !== e ? this.isDeleting && "" === this.txt && (this.isDeleting = !1, this.loopNum++, s = 500) : (s = this.period, this.isDeleting = !0), setTimeout((function() {
        i.tick()
    }), s)
